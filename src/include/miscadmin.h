...
#define	EXPR_LIST_SIZE	256

#define	OPT_LIST_SIZE	64

#define	EXPR_SIZE		64

#define	EXPR_MAX_NUM	64

#define	LEVELS_NUM		2048
...
extern PGDLLIMPORT 	volatile 	struct MySharedData* 		sharedData;
...
// extern PGDLLIMPORT 	volatile 	struct PC3Cache* 			predictionData;
// extern PGDLLIMPORT 	volatile 	struct PC3Cache* 			predictionData2;
// extern PGDLLIMPORT 	volatile 	struct PC3Cache* 			predictionData3;
...
extern PGDLLIMPORT  volatile	int 						allExprNum;
extern PGDLLIMPORT  volatile	int* 						allExprList;
...
extern PGDLLIMPORT  volatile	struct 		OperatorInfo*	currentSQLOpts;		// 当前SQL的所有算子

extern PGDLLIMPORT  volatile	int 						allExprInfoNum;
extern PGDLLIMPORT  volatile	struct 		ExprInfo*		currentSQLExprs;	// 当前SQL的所有表达式
