...
/* -------------------------------------  #RAIN PC3  -------------------------------------- */
extern void ProcWaitForSharedSignal(uint32 wait_event_info, int pid, long timeout); 	
extern Size TxnPoolShmemSize(void);
extern Size CommitTxnPoolShmemSize(void);
extern Size SharedDataShmemSize(void);
extern Size PC3CacheSize(void);
extern void SharedDataShmemInit(void);
extern void TransactionPoolInit(void);
extern void CommitTxnPoolInit(void);
extern void InitPC3Cache(void);
/* ---------------------------------------------------------------------------------------- */
