...
static struct config_bool ConfigureNamesBool[] =
{
	...
	/*************************************** #RAIN : ME **************************************/
	{
		{"enableME", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Enable ME."),
			NULL,
			GUC_EXPLAIN
		},
		&enableME,
	...
	{
		{"printExpr", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow expression information to be reported in files."),
			NULL,
			GUC_EXPLAIN
		},
		&printExpr,
	...
	{
		{"printExprLevels", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow expression levels to be printed."),
			NULL,
			GUC_EXPLAIN
		},
		&printExprLevels,
	...
	{
		{"printEEOP", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow expression steps to be printed."),
			NULL,
			GUC_EXPLAIN
		},
		&printEEOP,
	...
	{
		{"countExpr", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Allow expression to be counted with no jit."),
			NULL,
			GUC_EXPLAIN
		},
		&countExpr,
...
static struct config_int ConfigureNamesInt[] =
{
	...
	{
		{"Reserved1", PGC_SUSET, LOCK_MANAGEMENT,
			gettext_noop("Reserved Value."),
			NULL,
			GUC_UNIT_BYTE
		},
		&Reserved1,
	...
	{
		{"Reserved2", PGC_SUSET, LOCK_MANAGEMENT,
			gettext_noop("Reserved Value."),
			NULL,
			GUC_UNIT_BYTE
		},
	...
	{
		{"Reserved3", PGC_SUSET, LOCK_MANAGEMENT,
			gettext_noop("Reserved Value."),
			NULL,
			GUC_UNIT_BYTE
		},
